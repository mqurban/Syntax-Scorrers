...
if (isset($_POST['action']) && ($_POST['action'] == 'update')) {
	...
	if ($validation) {
		...
		if (isset($_POST['relpoststh_sliderView'])) {
			update_option('relpoststh_sliderView', sanitize_text_field(wp_unslash($_POST['relpoststh_sliderView'])));
		} else {
			update_option('relpoststh_sliderView', '0');
		}

		if (isset($_POST['relpoststh_mosaicView'])) {
			update_option('relpoststh_mosaicView', sanitize_text_field(wp_unslash($_POST['relpoststh_mosaicView'])));
		} else {
			update_option('relpoststh_mosaicView', '0');
		}
		...
		// if (isset($_POST['rpt_slider_style'])) {
		// 	update_option('rpt_slider_style', sanitize_text_field(wp_unslash($_POST['rpt_silder_style'])));
		// }

		if (isset($_POST['rpt_slider_style'])) {
			update_option('rpt_slider_style', sanitize_text_field(wp_unslash($_POST['rpt_slider_style'])));
		}
...
$relpoststh_mosaicView         = get_option('relpoststh_mosaicView', $this->auto);
$relpoststh_sliderView         = get_option('relpoststh_sliderView', $this->auto);
					...
					<div class="metabox-holder rpth-setting-options">
						<div class="postbox" id="content_general_options">
							<table class="form-table">
								<tr valign="top">
									...
									<td>
										<div class="rpt-td-wrap">
											<input type="checkbox" name="relpoststh_auto" id="relpoststh_auto" value="1" <?php
																															if ($relpoststh_auto) {
								...
								<!-- Enable Slider Mode start -->

								<tr valign="top" id="slider_view">
									<th scope="row">
										<?php _e('Slider Mode', 'related-posts-thumbnails'); ?>:
									</th>
									<td>
										<div class="rpt-td-wrap">
											<input type="checkbox" name="relpoststh_sliderView" id="relpoststh_sliderView" value="1" <?php if ($relpoststh_sliderView) {
																																			echo 'checked="checked"';
																																		}	?> />

											<label for="relpoststh_sliderView">
												<p class="description rpth-discription">
													<?php _e('Check this option to enable Slider View for Related Posts', 'related-posts-thumbnails'); ?>
												</p>
											</label>
										</div>
										<br />
								...
								<tr id="slider-style">
									<th scope="row">
										<?php _e('Select Slider Style', 'related-posts-thumbnails'); ?>:
									</th>
									<td>
										<div class="rpt-td-wrap">
											<select class="rpt_slider_style" name="rpt_slider_style" id="slider_options">
												<option value="style1" <?php
																		if (get_option('rpt_slider_style') == 'style1') {
																			echo 'selected';
																		}
																		?>>
													<?php _e('Style 1', 'related-posts-thumbnails'); ?>
												</option>
												<option value="style2" <?php
																		if (get_option('rpt_slider_style') == 'style2') {
																			echo 'selected';
																		}
																		?>>
													<?php _e('Style 2', 'related-posts-thumbnails'); ?>
												</option>
											</select>
										</div>
									</td>
								...
								<!-- Enable slider mode end -->


								<!-- Enable Mosaic View for Posts  -->

								<tr valign="top" id="mosaic_view">
									<th scope="row">
										<?php _e('Mosaic View ', 'related-posts-thumbnails'); ?>:
									</th>
									<td>
										<div class="rpt-td-wrap">
											<input type="checkbox" name="relpoststh_mosaicView" id="relpoststh_mosaicView" value="1" <?php if ($relpoststh_mosaicView) {
																																			echo 'checked="checked"';
																																		}	?> />

											<label for="relpoststh_mosaicView">
												<p class="description rpth-discription">
													<?php _e('Check this option to enable Mosaic View for Related Posts', 'related-posts-thumbnails'); ?>
												</p>
											</label>
										</div>
										<br />
								...
								<tr valign="top">
									...
									<td>
										<div class="rpt-td-wrap">
											<input type="checkbox" name="relpoststh_devmode" id="relpoststh_devmode" value="1" <?php
								...
								<tr valign="top">
									...
									<td>
										<div class="rpt-td-wrap">
											<input type="checkbox" name="relpoststh_single_only" id="relpoststh_single_only" value="1" <?php
											...
											?>
												<select class="chosen-select" multiple name="relpoststh_post_types[]">
													<?php foreach ($post_types as $post_type) : ?>
														<option value="<?php echo esc_attr($post_type); ?>" <?php if (in_array($post_type, $relpoststh_post_types)) echo 'selected'; ?>>
								...
								<tr valign="top">
									...
									<td>
										<input type="checkbox" name="relpoststh_show_taxonomy" id="relpoststh_show_taxonomy" value="1" <?php
								...
								<tr valign="top">
									...
									<td>
										<div class="rpt-td-wrap">
											<input type="checkbox" name="relpoststh_mobile_view" id="relpoststh_mobile_view" value="1" <?php
								...
								<tr>
									...
									<td>
										<div class="rpt-td-wrap">
											<input type="checkbox" name="relpoststh_show_date" id="relpoststh_show_date" value="1" <?php if ($relpoststh_show_date) {
																																		echo 'checked="checked"';
																																	} ?> />
											...
											<select name="relpoststh_date_format" id="relpoststh_date_format">
												<?php foreach ($rpt_date_format as $date => $date_format) : ?>
													<div class="rpt-td-wrap-inner">
														<option value="<?php echo $date; ?>" <?php if ($relpoststh_date_format == $date) {
																									echo 'selected';
																								} ?>>
								...
								<table class="form-table">
									...
									<?php if (current_theme_supports('post-thumbnails')) : ?>
										<tr>
											...
											<td>
												<div class="rpt-td-wrap">
													<input type="checkbox" name="onlywiththumbs" id="onlywiththumbs" value="1" <?php if ($onlywiththumbs) {
																																	echo 'checked="checked"';
																																} ?> />
								...
								<tr>
										...
										<div class="rpt-td-wrap">
											<select name="relpoststh_output_style" id="relpoststh_output_style">
												<?php foreach ($output_styles as $name => $title) : ?>
													<option value="<?php echo $name; ?>" <?php if ($relpoststh_output_style == $name) {
																								echo 'selected';
																							} ?>>
														<?php echo $title; ?>
													</option>
									...
									if ($relpoststh_output_style == 'list') {
										...
										echo 'none';
												...
												<div class="rpt-td-wrap">
													<input type="checkbox" name="relpoststh_cleanhtml" id="relpoststh_cleanhtml_label" <?php if ($relpoststh_cleanhtml) {
																																			echo 'checked="checked"';
																																		} ?> />
											...
											if (is_array($relation_options) && count($relation_options)) :
												foreach ($relation_options as $ro_key => $ro_name) : ?>
													<div class="rpt-radio-wrap">
														<input type="radio" name="relpoststh_relation" id="relpoststh_relation_<?php echo esc_html_e($ro_key,  'related-posts-thumbnails'); ?>" value="<?php echo $ro_key; ?>" <?php if ($relpoststh_relation == $ro_key) {
																																																									echo 'checked="checked"';
																																																								} ?> />
												...
												<div class="rpt-td-wrap rpt-multi-content-wrap">
													...
													if (is_array($custom_taxonomies) && count($custom_taxonomies)) :
														foreach ($custom_taxonomies as $custom_taxonomy) : ?>
															<div class="rpt-td-wrap-inner">
																<input type="checkbox" name="relpoststh_custom_taxonomies[]" id="ct_<?php echo $custom_taxonomy; ?>" value="<?php echo $custom_taxonomy; ?>" <?php
